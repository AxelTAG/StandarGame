...
class Game:
    ...
    skip_input_action: bool = field(default=False)
    ...
    def show_play(self):
        ...
        while self.play:
            ...
            if self.play and player.is_alive():
                ...
                if action[0:2] == ["catch", "dream"]:
                    screen = catch_dream(filepath=action[2], player=player, mapgame=map_game)
