...
BIOMES = {
    ...
    "dark forest": Biome(
        ...
        description="Shadowy forest of peril, twisted trees loom overhead, their gnarled branches casting eerie "
                    "shadows. ",
        fight=True,
        mobs=["spectral foxshade", "giant spider", "poison spider"],
    ...
    "forest": Biome(
        ...
        description="Thick trees, vibrant flora, wildlife, hidden trails, and lurking danger in this treacherous "
                    "forest realm.",
        fight=True,
        mobs=["bandit", "spectral foxshade", "poison spider", "poison slime"],
        mobs_chances=[20, 1, 10, 5],
        name="FOREST",
        req=[],
        pace=6,
        status=[PlayerStatus.WALK.value]),
...
MOBS = {
    ...
    "goblin war": Mob(
        ...
        items_drop_chances=[0.5, 0.6, 0.7, 1],
        experience=4,
    ),
    ...
    "shadow wolf": Mob(
        ...
        poison_chance=0,
        escape_chance=20,
        items={"wolf_fur": 1, "wolf_claw": 2, "none": None},
        items_drop_chances=[0.3, 0.5, 1],
        experience=15,
    ),
...
NPCS = {
    ...
    "merchant_bryson": Npc(name="merchant bryson",
                           ...
                           answers={
                               1: "Buy",
                               2: "Sell"},
                           buy_items={"antidote": 10, "leather_armor": 75, "leather_boots": 60, "little_red_potion": 5,
    ...
    "merchant_roland": Npc(name="merchant roland",
                           ...
                           answers={
                               1: "Buy",
                               2: "Sell"},
                           buy_items={"antidote": 10, "giant_red_potion": 15, "red_potion": 10, "sword": 300,
    ...
    "merchant_selena": Npc(name="merchant selena",
                           ...
                           answers={
                               1: "Buy",
                               2: "Sell"},
                           buy_items={"antidote": 10, "harpoon": 150, "hardened_leather_armor": 120, "red_potion": 10,
